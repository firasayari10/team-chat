...
export const InviteModal = (
    {open ,setOpen , name ,joinCode}:InviteModalProps
) => {

    const workspaceId = useWorkspaceId();
    const [ConfirmDialog ,confirm]= useConfirm("Are you sure ?","Regenerating a new code will prohibit members to join with the old code !")
