...
export const WorkspaceHeader = ({workspace , isAdmin}:WorkspaceHeaderProps) => {
    const [prefrnecesopen , setPrefrencesOpen] = useState(false) ;
    
    
    return (
        <>
        <PreferencesModal open={prefrnecesopen} setOpen={setPrefrencesOpen} initialValue={workspace.name}/>
        <div className="flex items-center justify-between px-4 h-[49px] gap-0.5">
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    ...
                    <ChevronDown className="size-4 shrink-1 ml-1" />
                    </Button>
                </DropdownMenuTrigger>
                ...
                <DropdownMenuContent side="bottom" align="start" className="w-64">
                    ...
                    <>
                        ...
                        onClick={() => {}}
                        >
                        Invite people to join workspace
                        </DropdownMenuItem>
