...
import {AlertTriangle, HashIcon, Loader, MessagesSquare, SendHorizonal} from "lucide-react"
import {WorkspaceHeader} from "./workspace-header"
import { SidebarItem} from "./side-bar-item"
import { useGetChannels } from "@/features/channels/api/use-get-channels";
import {WorkspaceSection} from "./work-space-section"
...
export const WorkspaceSideBar =()=> {
    ...
    return  (  
        ...
        <div className="flex flex-col  bg-[#5E2C5F] h-screen ">
